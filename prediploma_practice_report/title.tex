...
\vspace{2\baselineskip}
\includegraphics[width=4cm]{../report/logo.png}

\vspace{2\baselineskip}
\textbf{\MakeUppercase{Отчёт по преддипломной практике}}

\vspace{\baselineskip}
на тему \textbf{«Разработка интерактивной программы визуализации движения частиц в полях скоростей»}
\end{center}
